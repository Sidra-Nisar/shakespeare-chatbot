...
│
└── docs/
    └── Shakespeare_chatbot_report.pdf
```
...
| `shakespeare_index.faiss` | Stores the searchable vector index                             |
...
![Retrieved Results](screenshots/chatbot-results.png)
